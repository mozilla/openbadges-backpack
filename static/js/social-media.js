...
SocialMedia.prototype = {
  urlPlaceHolder: "__URL__PLACE__HOLDER__",

  facebook: {
    id: "facebook-jssdk",
    src: "//connect.facebook.net/en_US/all.js#xfbml=1",
    html: "<div class='fb-like' data-href='"+this.urlPlaceHolder+"' data-send='false' data-action='recommend' data-layout='button_count' data-show-faces='false' data-font='tahoma'></div>",
  ...
  google: {
    ...
    html: "<g:plusone annotation='none' href='"+this.urlPlaceHolder+"'></g:plusone>"
  },

  twitter: {
    id: "twitter-wjs",
    src: "//platform.twitter.com/widgets.js",
    html: "<a href='https://twitter.com/share'class='twitter-share-button' data-text='Check out the #MozThimble page I just made: ' data-url='"+this.urlPlaceHolder+"' data-via='Mozilla' data-count='none'>Tweet</a>"
  },
  ...
  hotLoad:  function(element, socialMedium, url) {
    ...
    var html = socialMedium.html.replace(this.urlPlaceHolder, url);
