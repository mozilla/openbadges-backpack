...
app.post('/backpack/badge', middleware.statsdRequests(), backpack.userBadgeUpload);
app.post('/backpack/authenticate', middleware.statsdRequests(), backpack.authenticate);
