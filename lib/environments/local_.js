...
exports.config = {
  ...
  database: {
    ...
    user: process.env.DATABASE_USER || 'obe2e',
    password: process.env.DATABASE_PASS || 'qqUuJA62NyHf4p48',
    database: process.env.DATABASE_NAME || 'keith_openbadges_e2e'
  },
  ...
  mailer: {
    service: 'mailgun',
    user: 'postmaster@mg.openbadges.org',
    pass: '31680e3a06eb3e1d75962ae3bd76528e' 
  },
