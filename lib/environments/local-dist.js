...
exports.config = {
  ...
  // auth credentials for SMTP mail transport
  // Supports and well-known service -- https://github.com/nodemailer/nodemailer-wellknown#supported-services
  mailer: {
    service: 'Mandrill',
  ...
  // these are here in case we decide to add these strategies to passport, further down the line
  // commented out for now
  // Should the time come that we enable them, we'll need to pull them in in the heroku config also!
  /*passportStrategyConfigs: {
    facebookAuth: {
    ...
    deviantArt: {
      clientID       : 'client_id_here',
      clientSecret   : 'client_secret_here',
      callbackURL    : 'http://example.com/auth/deviantart/callback'
    }
  }*/
